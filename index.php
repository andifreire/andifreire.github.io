...
if (!empty($_POST)) {
	...
	$sql = "SELECT idusuarios FROM usuarios  
			WHERE usuario = '$usuario' AND password = '$password1'";
...
if(isset($_POST['registrar'])){
		...
		if($filas > 0 ) {
			...
			$sqlusuario = "INSERT INTO usuarios(Nombre,Correo,Usuario,Password)
							VALUES ('$nombre','$correo', '$usuario', '$password1')";
			...
			if($resultadousuario > 0 ){
				...
				echo "<script>
					alert('ERROR AL REGISTRARSE BIGOTE);
					window.location = 'index.php' ;
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="social-login center">
												...
												<a href="https://www.facebook.com/freire.andi" target="_blank" class="btn btn-primary">
													<i class="ace-icon fa fa-facebook"></i>
												</a>

												<a href="https://twitter.com/andi_roman_" target="_blank" class="btn btn-info">
													<i class="ace-icon fa fa-twitter"></i>
												</a>

												<a href="https://www.instagram.com/freire.andi/" target="_blank" class="btn btn-danger">
